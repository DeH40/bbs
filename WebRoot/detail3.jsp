					  		...
					  		<li class="media">
							    <div class="media-left">
							        ...
							        <div class="media-object" style="width:50px">
								        <img src="<%=r.getUser().getUface()%>" title="<%=r.getUser().getUname()%>"  style="max-width:50px;max-height:50px">
								        <a href="#">
								        <br/>
								        	<%=r.getUser().getUname() %>
								        </a>
							    ...
							    <div class="media-body">
							      <div class="well well-lg"><%=r.getContent()%></div>
								  ...
								  <div class="well well-sm"><%=DateFormat.dateToString(r.getRtime())%></div>
								  ...
								  %>
									<!-- <div class="media"> -->
							    		...
							    		<%-- <div class="media-body">
										   ...
										   <tr>
										    <td rowspan="2" width="50px"><img src="<%=reply.getUser().getUface()%>" title="<%=reply.getUser().getUname()%>" style="max-width:50px;max-height:50px"></td>
										    <td>
										      <strong>
										        <%=reply.getUser().getUname()%>
                                                <%=reply.getPuser().getUid() == r.getUser().getUid() || reply.getUser().getUid() ==  reply.getPuser().getUid() ? ":":"回复："+reply.getPuser().getUname() %>
